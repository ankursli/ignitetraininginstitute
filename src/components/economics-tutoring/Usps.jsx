// Economics Usps component updated for global Locomotive Scroll
...
const uspData = [
  { number: "01", icon: "/images/usp-icon1.webp", title: "Expert Guidance", desc: "Gain deep subject insight from experienced Economics tutors.", width: 77, height: 67 },
  { number: "02", icon: "/images/usp-icon2.webp", title: "Clear Concepts", desc: "Understand complex theories through simplified, clear explanations.", width: 67, height: 63 },
  { number: "03", icon: "/images/usp-icon3.webp", title: "Proven Results", desc: "Track record of consistently high Economics exam scores.", width: 76, height: 69 },
  { number: "04", icon: "/images/usp-icon4.webp", title: "Flexible Approach", desc: "Learn on your terms with schedule-friendly Economics sessions.", width: 66, height: 71 },
  { number: "05", icon: "/images/usp-icon5.webp", title: "Tailored Support", desc: "Personalized guidance aligned to your curriculum and goals.", width: 78, height: 74 },
  { number: "06", icon: "/images/usp-icon6.webp", title: "Practical Knowledge", desc: "Connect classroom theory with real-world economic applications.", width: 76, height: 78 },
  { number: "07", icon: "/images/usp-icon1.webp", title: "Exam Excellence", desc: "Curriculum-focused prep to excel in Economics assessments.", width: 77, height: 67 },
  { number: "08", icon: "/images/usp-icon2.webp", title: "Boosted Confidence", desc: "Build academic confidence through clarity and consistent support.", width: 67, height: 63 },
];
