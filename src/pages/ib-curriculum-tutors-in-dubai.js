...
const CourseCard = dynamic(() => import('@/components/ibc/CourseCard'));
...
const LifeAtIgniteCarousel = dynamic(() => import('@/components/ibc/LifeAtIgniteCarousel'));
...
const StudentAchievements = dynamic(() => import('@/components/ibc/StudentAchivement'));
